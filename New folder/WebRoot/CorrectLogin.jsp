...
<div style="position:absolute; left:608px; width:50%; height:220px; top: -230px;">
  ...
  <br><br>
	...
	<div style="position:absolute; right:683px; width:50%; height:220px; top: -200px;">
		<h3 class="wow bounceIn" style="color:#FFcc00;margin-left:-30px;margin-top:40px">INVALID LOGIN</h3>
		<h4 class="wow bounceIn" style="color:#FFffff;margin-left:-30px">Enter Correct Email and Password</h4><BR>
    </div>				
...
<h3 class="color-white">&nbsp;</h3>
  <div class="col-md-offset-1 col-md-10 col-sm-12">
    <form action="login.jsp" method="post" class="wow fadeInUp" data-wow-delay="0.4s">
      ...
      <div class="col-md-4 col-sm-6">
        <input type="email" required="required" class="form-control" placeholder="Email" name="email1" style="color:#000000; width:150px;background-color:#FFFFff ">
      </div>
      <div class="col-md-4 col-sm-12">
        <input type="password" required="required" class="form-control" placeholder="Password" name="pass" style="color:#000000; width:150px; margin-left:0px;background-color:#FFFFff">
      </div>
      <div class="col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8">
