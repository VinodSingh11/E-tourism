...
================================================== -->
			<div class="col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8">
				<div class="section-title" style="border-color:transparent;margin-top:25px;border-spacing:inherit;width:450px;height:40px;margin-left:-70px">
					<h2 class="wow bounceIn" style="color:#FFCC00;margin-top:-50px;margin-left:-280px">MY TRIP</h2><hr style="border-color:#FFCC00;margin-left:-30px;margin-top:-20px">
					<!--<h1 class="heading">CONTACT US</h1>-->
					
					
				</div>
				            <form action="MyTripUser.jsp" method="post" class="wow fadeInUp" data-wow-delay="0.6s">
