	...
	<div class="container" style="background-color:#FFCC00">
		...
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="#about" class="smoothScroll">ABOUT</a></li>
				<li><a href="#team" class="smoothScroll">CONTACT US</a></li>
	...
	<div class="site-slider">
     ...
     <div class="slider-caption">
		      ...
		      <div align="center"><h3 class="plan-title" style="color:#FFCC00">CUSTOM INDIA TOUR</h3><hr style="margin-bottom:2PX;margin-top:-3PX;border-color:#FFCC00">				  
                ...
                <form action="Enquire.jsp" method="post" class="wow fadeInUp" data-wow-delay="0.4s"> <input name="tour3" type="submit"  class="form-control" value="Get Started Now  >>" style="background-color:#FFCC00;color:#FFFFFF;width:200px;margin-top:-25PX"></form>  
...
================================================== -->
 <div class="col-md-4 col-sm-6">
				<div class="grid">
					...
					<a href="ExploreTrip.jsp?id=1">	<img src="images/trip/tp1.jpg" alt="portfolio img" style="height:240px;width:360px"/></a>
							<figcaption>
            ...
            <div class="col-md-4 col-sm-6">
				<div class="grid">
              		<figure class="effect-zoe">
						<a href="ExploreTrip.jsp?id=2">	<img src="images/trip/tp2.jpg" alt="portfolio img" style="height:240px;width:360px"/></a>
							<figcaption>
            ...
            <div class="col-md-4 col-sm-6">
				<div class="grid">
              		<figure class="effect-zoe">
						<a href="ExploreTrip.jsp?id=3">	<img src="images/trip/tp3.jpg" alt="portfolio img" style="height:240px;width:360px"/></a>
							<figcaption>
          	 ...
          	 <div class="col-md-4 col-sm-6">
				<div class="grid">
              		<figure class="effect-zoe">
						<a href="ExploreTrip.jsp?id=4">	<img src="images/trip/tp4.jpg" alt="portfolio img" style="height:240px;width:360px"/></a>
							<figcaption>
           ...
           <div class="col-md-4 col-sm-6">
				<div class="grid">
              		<figure class="effect-zoe">
						<a href="ExploreTrip.jsp?id=5">	<img src="images/trip/tp5.jpg" alt="portfolio img" style="height:240px;width:360px"/></a>
							<figcaption>
            ...
            <div class="col-md-4 col-sm-6">
				<div class="grid">
              		<figure class="effect-zoe">
						<a href="ExploreTrip.jsp?id=6">	<img src="images/trip/tp6.jpg" alt="portfolio img" style="height:240px;width:360px"/></a>
							<figcaption>
...
================================================== -->
         ...
         <div class="col-md-4 col-sm-6" id="sddd">
			<div class="grid">
              		<figure class="effect-zoe">
					<a href="ExploreTrip.jsp?id=7">	<img src="images/trip/tp7.jpg" alt="portfolio img" style="height:240px;width:360px"/></a>
							<figcaption>
       ...
       <div class="col-md-4 col-sm-6">
				<div class="grid">
              		<figure class="effect-zoe">
						<a href="ExploreTrip.jsp?id=8">	<img src="images/trip/tp8.jpg" alt="portfolio img" style="height:240px;width:360px"/></a>
							<figcaption>
            ...
            <div class="col-md-4 col-sm-6">
				<div class="grid">
              		<figure class="effect-zoe">
						<a href="ExploreTrip.jsp?id=9">	<img src="images/trip/tp9.jpg" alt="portfolio img" style="height:240px;width:360px"/></a>
							<figcaption>
          	 ...
          	 <div class="col-md-4 col-sm-6">
				<div class="grid">
              		<figure class="effect-zoe">
						<a href="ExploreTrip.jsp?id=10">	<img src="images/trip/tp10.jpg" alt="portfolio img" style="height:240px;width:360px"/></a>
							<figcaption>
          ...
          <div class="col-md-4 col-sm-6">
				<div class="grid">
              		<figure class="effect-zoe">
						<a href="ExploreTrip.jsp?id=11">	<img src="images/trip/tp11.jpg" alt="portfolio img" style="height:240px;width:360px"/></a>
							<figcaption>
         ...
         <div class="col-md-4 col-sm-6">
				<div class="grid">
              		<figure class="effect-zoe">
						<a href="ExploreTrip.jsp?id=12">	<img src="images/trip/tp12.jpg" alt="portfolio img" style="height:240px;width:360px"/></a>
							<figcaption>
...
================================================== -->
            ...
            <div class="col-md-4 col-sm-6" id="sddd">
				<div class="grid">
              		<figure class="effect-zoe">
						<a href="ExploreTrip.jsp?id=13">	<img src="images/trip/tp13.jpg" alt="portfolio img" style="height:240px;width:360px"/></a>
							<figcaption>
            ...
            <div class="col-md-4 col-sm-6">
				<div class="grid">
              		<figure class="effect-zoe">
						<a href="ExploreTrip.jsp?id=14">	<img src="images/trip/tp14.JPG" alt="portfolio img" style="height:240px;width:360px"/></a>
							<figcaption>
            ...
            <div class="col-md-4 col-sm-6">
				<div class="grid">
              		<figure class="effect-zoe">
						<a href="ExploreTrip.jsp?id=15">	<img src="images/trip/tp15.JPG" alt="portfolio img" style="height:240px;width:360px"/></a>
							<figcaption>
            ...
            <div class="col-md-4 col-sm-6">
				<div class="grid">
              		<figure class="effect-zoe">
						<a href="ExploreTrip.jsp?id=16">	<img src="images/trip/tp16.JPG" alt="portfolio img" style="height:240px;width:360px"/></a>
							<figcaption>
            ...
            <div class="col-md-4 col-sm-6">
				<div class="grid">
              		<figure class="effect-zoe">
						<a href="ExploreTrip.jsp?id=17">	<img src="images/trip/tp17.jpg" alt="portfolio img" style="height:240px;width:360px"/></a>
							<figcaption>
            ...
            <div class="col-md-4 col-sm-6">
				<div class="grid">
              		<figure class="effect-zoe">
						<a href="ExploreTrip.jsp?id=18">	<img src="images/trip/tp18.jpg" alt="portfolio img" style="height:240px;width:360px"/></a>
							<figcaption>
		...
		<div class="row">
            ...
            <div class="col-md-offset-2 col-md-8 col-sm-12">
            	<div class="portfolio-bottom">
					...
					<a href="Enquire.jsp" class="smoothScroll btn btn-default">HELP ME PLAN MY TRIP >></a>  	</div>
            	<br>
<br>
<br>
...
================================================== -->
			...
			<div class="col-md-6 col-sm-12">
				...
				We're experts at finding and matching you with the world's finest travel agents and boutique tour companies. Each travel specialist partner on TOURISTY is personally and meticulously screened by us. You'll only be matched with specialists who are true experts at customizing your particular trip.</p>
			</div>
				...
				<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
  					...
  					<div class="panel panel-default">
   						...
   						<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
      						<div class="panel-body">
        						<p>Tell us about your ideal trip and the kind of experiences you'd like to include. We will match you with 2-3 reputable, pre-qualified travel specialists who are the best fit for your trip.</p>
      						</div>
   						 </div>
 					 </div>
					...
					<div class="panel panel-default">
   						...
   						<div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
      						<div class="panel-body">
        						<p>After your trip we'll invite you to write a review, so you can help other travelers with your candid feedback. Only travelers who have purchased a trip through TOURISTY are eligible to share their travel reviews.</p>
      						</div>
   						 </div>
 					 </div>
			...
			<div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="1.3s">
				<div class="team-wrapper">
				   <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3559.0077241113127!2d75.79472141504408!3d26.87149568314537!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x396dca04b57eac93%3A0xa505820ddf73e262!2sRAT+Monopoly+In+Java!5e0!3m2!1sen!2sin!4v1468644191246" width="350" height="361" frameborder="0" style="border:0" allowfullscreen></iframe>
					<div>
					    <p>&nbsp;</p><br><br>
						<h4 style="color:#FFCC00">Are you a <em>Top Travel Specialist ?</em></h4>
			            <a href="contactus.jsp" data-wow-delay="0.3s" style="color:#787878">Click here to Contact us.</a>
