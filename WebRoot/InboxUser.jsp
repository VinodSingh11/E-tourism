...
<div class="col-md-offset-1 col-md-10 col-sm-12">
		...
		<div class="wow bounceIn" style="width:100%;height:200px;background-color:transparent;margin-top:-80px">   
		
		<table class="table table-hover" style="border-color: #000000">
    <thead>
      <tr>
        <th style="color: #ffcc00;width: 600px">Subject</th>
        <th style="color: #ffcc00;">Date</th>

        <th style="color: #ffcc00;width: 30px"></th>
      </tr><%
      String em=session.getAttribute("email").toString();
String sqlqry1="select * from userinbox where email=? order by id desc";
...
%><tbody><tr>
<td><a href=InboxMsgUser.jsp?id=<%=id %> style="color:#000000"><%=rs2.getString(3)%></a></td>
<td><a href=InboxMsgUser.jsp?id=<%=id %>  style="color:#000000"><%=rs2.getString(5)%></a></td>

<td><a href=deleteusermsg.jsp?id=<%=id %>><img src="images/del.jpg"></a></td>
<%
}}
catch(Exception e)
{
