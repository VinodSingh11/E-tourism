...
<div class="col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8">
	...
	<h3 class="wow bounceIn" style="color:#FFCC00;margin-top:-50px;margin-left:-330px">UPCOMING TRIPS</h3><hr style="border-color:#FFCC00;margin-left:-30px;margin-top:0px">
...
<div class="col-md-offset-1 col-md-10 col-sm-12">
    ...
    <thead>
      <tr>
        <th style="color: #ffcc00;width: 150px">TRIP-ID</th>
        <th style="color: #ffcc00;width: 150px"">PLAN-ID</th>
        <th style="color: #ffcc00;width: ">EMAIL</th>
        <th style="color: #ffcc00;width:200px ">DESTINATION</th>
        <th style="color: #ffcc00;width: 250px">DEPT. DATE</th>
      </tr><%
...
String date=rs13.getString(5);
%><tbody><tr>
<td><a style="color:#000000"><%=tripid%></a></td>
<td><a style="color:#000000"><%=planid%></a></td>
<td><a style="color:#000000"><%=email%></a></td>
<td><a style="color:#000000"><%=dest%></a></td>
<td><a style="color:#000000"><%=date%></a></td>
<%
}}
catch(Exception e)
{
