  ...
  <div class="site-slider">
	  <div class="container">
          <div class="row"></div>
                ...
                <!--<img src="images/slider/slide4.jpg" alt="slider image 1" style="height:665px;width:100%;margin-top:0px">-->
                <div class="container">
                    <div class="row">
                      <div class="col-md-12">
...
<div style="position:absolute; left:608px; width:50%; height:220px; top: -230px;">
  ...
  <form action="next1.jsp" method="post" class="wow fadeInUp" data-wow-delay="0.9s">
  <div class="col-md-4 col-sm-6">
    
	<input type="text" class="form-control" placeholder="Name" name="uname" style="color:#787878; width:300px; margin-left:125px;background-color:#FFFFff" required="true">
  </div><br><br>
  <div class="col-md-4 col-sm-6">
    <input type="email" class="form-control" placeholder="Email" name="remail" style="color:#787878; width:300px; margin-left:125px;background-color:#FFFFff" required="true">
  </div><br><br>
  <div class="col-md-4 col-sm-6">
    <input type="text" class="form-control" placeholder="Contact" name="cont" style="color:#787878; width:300px; margin-left:125px;background-color:#FFFFff" required="true">
  </div><br><br>
  <div class="col-md-4 col-sm-6">
    <input type="password" class="form-control" placeholder="Password" name="pswd" style="color:#787878; width:300px; margin-left:125px;background-color:#FFFFff" required="true">
  </div><br><br>
  <div class="col-md-4 col-sm-6">
    <input type="password" class="form-control" placeholder="Retype Password" name="repswd" style="color:#787878; width:300px; margin-left:125px;background-color:#FFFFff" required="true">
  </div><br><br>
  
   <div class="col-md-4 col-sm-6">
  <select id="edit-field-countries-und-0-target-id" class="form-control" name="dest" class="form-select required" style="width:180px;color:#787878; margin-left:125px">
   ...
   <input type="text" class="form-control" placeholder="Your Answer" name="ans" style="color:#787878; width:110px; margin-left:315px;background-color:#FFFFff;margin-top:-34px">
  </div><br><br>

  <div class="col-md-4 col-sm-6">
  <img src="captcha.jsp" style="margin-left: 125px"/>
  <input type="text" class="form-control" placeholder="Enter Captcha" name="cname" style="color:#787878; width:200px; margin-left:225px;background-color:#FFFFff;margin-top:-34px">
  </div><br>
...
<h3 class="color-white">&nbsp;</h3>
  <div class="col-md-offset-1 col-md-10 col-sm-12">
    <form action="login.jsp" method="post" class="wow fadeInUp" data-wow-delay="0.4s">
      ...
      <div class="col-md-4 col-sm-6">
        <input type="email" class="form-control" placeholder="Email" name="email1" style="color:#000000; width:150px;background-color:#FFFFff "required="true">
      </div>
      <div class="col-md-4 col-sm-12">
        <input type="password" class="form-control" placeholder="Password" name="pass" style="color:#000000; width:150px; margin-left:0px;background-color:#FFFFff"required="true">
      </div>
      <div class="col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8">
