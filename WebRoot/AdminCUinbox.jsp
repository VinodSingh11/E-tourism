...
<div class="col-md-offset-1 col-md-10 col-sm-12">
		...
		<div class="wow bounceIn" style="width:100%;height:400px;background-color:transparent;margin-top:-80px">   <!--working area for inbox showing --> 
		
  
  <table class="table table-hover" style="border-color: #000000">
    <thead>
      <tr>
        <th style="color: #ffcc00;width: 180px">Name</th>
        <th style="color: #ffcc00">Subject</th>
        <th style="color: #ffcc00;width: 150px">Date</th>
        <th style="color: #ffcc00;width: 100px">Time</th>
        <th style="color: #ffcc00;width: 30px"></th>
      </tr><%
String sqlqry="select * from admininbox order by id desc";
...
%><tbody><tr>
<td><a href=AdminCUinboxMsg.jsp?id=<%=id %>&&email=<%=email %> style="color:#000000"><%=rs1.getString(3)%></a></td>
<td><a href=AdminCUinboxMsg.jsp?id=<%=id %>&&email=<%=email %>  style="color:#000000"><%=rs1.getString(4)%></a></td>
<td><a href=AdminCUinboxMsg.jsp?id=<%=id %>&&email=<%=email %>  style="color:#000000"><%=rs1.getString(6)%></a></td>
<td><a href=AdminCUinboxMsg.jsp?id=<%=id %>&&email=<%=email %>  style="color:#000000"><%=rs1.getString(7)%></a></td>

<td><a href=deleteadminmsg.jsp?id=<%=id %>><img src="images/del.jpg"></a></td>
<%
}}
catch(Exception e)
{
